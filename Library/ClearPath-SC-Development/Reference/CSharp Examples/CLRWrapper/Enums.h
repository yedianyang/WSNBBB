...
namespace sFndCLIWrapper {
	...
	public enum class cliNodeStopCodes {
		...
		*/
		STOP_TYPE_ABRUPT = 0x00,		// Kill Motion Abruptly
										...
										zero using the E-Stop Deceleration Rate.
										*/
		STOP_TYPE_RAMP = 0x01,		// Kill Motion with decel limit
									/*
									Ignore any node stop requests.
									This mode does not affect directed node stops via commands.
									*/
		...
		STOP_TYPE_RAMP_AT_DECEL = 0x04,		// Kill Motion with active decel limit
											...
											Future motion is blocked until a directed NodeStopClear
											is sent.
											*/
		...
		STOP_TYPE_ESTOP_RAMP = 0x11,		// E-Stop Ramping to stop
											/*
											Flush any pending motion commands and ramp the node's speed to
											zero using the active decel rate.
		...
		STOP_TYPE_DISABLE_RAMP_AT_DECEL = 0x80,		// E-Stop Ramping to stop
													/*
													This stop type will prevent future motion and set the Output
													Register enable state to disabled.

													This node stop can be canceled by a directed NodeStopClear
													command.
													*/
		...
		STOP_TYPE_CLR_DISABLE = 0x88,		// Restore enable state
											...
											E-Stop and the Controlled Output conditions.
											*/
	...
	*/
	...
	public enum class cliCNErrCode {
		MN_OK,				    	///< 0x0:      	   function succeeded
		MN_ERR_FAIL = (int)(MN_ERR_BASE + 1),	///< 0x80040001:   function generically failed
		...
		MN_ERR_24V_OFF,				///< 0x80000047:   Canceled due to lack of 24V supply
									...
									/* ----------------------- MN_ERR_CMD ----------------------------*/
									MN_ERR_CMD_INTERNAL = (int)MN_ERR_CMD_ERR_BASE,
									...
									MN_ERR_CMD_MV_BLOCKED,		///< 0x8004010c: Motion blocked / non-disabling shutdown present
																...
																MN_ERR_NODE_IN_MOTION = (int)(MN_ERR_CMD_ERR_BASE + 0x10),	///< 0x80040110:   Drive is in motion

																MN_ERR_CMD_ERR_END, // Used for class of error range
																					/* -------------------- END OF MN_ERR_CMD GROUP ------------------*/

																					/* ------------------------- MN_ERR_NET --------------------------------*/
																					MN_ERR_NET_FRAG = (int)MN_ERR_NET_ERR_BASE,
																					...
																					MN_ERR_NET_ERR_END,	// Used for class of error range
																										...
																										/// and the node \e yy.
																										MN_ERR_BRK_OTHER_00_01 = (int)MN_ERR_NETBREAK_ERR_BASE,
																										...
																										MN_ERR_BRK_OTHER_15_HOST, 	// 0x8004030f: Net Break OTHER: node 15-host
																																	...
																																	/// and the node \e yy.
																																	MN_ERR_BRK_APP_00_01 = (int)(MN_ERR_NETBREAK_ERR_BASE + 0x10),
																																	...
																																	MN_ERR_BRK_APP_15_TO_HOST,	// 0x8004031f: Net Break APP: node 15-host
																																								...
																																								**/
		MN_ERR_BRK_DIAG_00_01 = (int)(MN_ERR_NETBREAK_ERR_BASE + 0x20),
		...
		**/
		...
		MN_ERR_BRK_DIAG_15_TO_HOST,	// 0x8004032f: Net Break DIAG: node 15-host 
									...
									/// Network Break detected on the application channel between node \e xx 
									/// and the host.
									MN_ERR_BRK_APP_00_HOST = (int)(MN_ERR_NETBREAK_ERR_BASE + 0x30),
									...
									\e 0 and the host.
									**/
		MN_ERR_BRK_DIAG_00_HOST = (int)(MN_ERR_NETBREAK_ERR_BASE + 0x40),
		/**
		...
		**/
		...
		MN_ERR_BRK_00_HOST = (int)(MN_ERR_NETBREAK_ERR_BASE + 0x50),
		...
		MN_ERR_OFFLINE_00 = (int)(MN_ERR_NETBREAK_ERR_BASE + 0xa0),
		...
		MN_ERR_OFFLINE_15,	    	// 0x800403af: Node 15 detected offline
									...
									MN_ERR_BRK_DIAG_LOC_UNKNOWN = (int)(MN_ERR_NETBREAK_ERR_BASE + 0xFC),
									...
									MN_ERR_NO_NET_CONNECTIVITY,	///< 0x800403ff: Cannot detect net connectivity
																...
																**/
		MN_ERR_INIT_FAILED_BASE = (int)0x80040600,
		/**
		...
		**/
		...
		MN_ERR_INIT_FAILED_PORTS_2_1_0,		// 0x80040607: Port 2&1&0 problem
											...
											**/
		MN_ERR_PORT_FAILED_BASE = (int)0x80040700,
		/**
		...
		**/
		...
		MN_ERR_PORT_FAILED_PORTS_2_1_0,		// 0x80040707: Port 2&1&0 problem
											...
											**/
		MN_ERR_BAUD_FAILED_BASE = (int)0x80040800,
		/**
