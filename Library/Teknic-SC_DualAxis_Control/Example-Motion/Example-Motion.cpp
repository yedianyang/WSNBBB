...
#include <string>
#include <iostream>
#include "/home/yedianyang/src/Teknic/inc/inc-pub/pubSysCls.h"	
		...
		for (size_t i = 0; i < portCount; i++) {
			...
			for (size_t i = 0; i < NUM_MOVES; i++)
			{
				for (size_t iNode = 0; iNode < 1; iNode++) {
					...
					printf("%f estimated time.\n", theNode.Motion.MovePosnStart(1000, true));
					printf("Node %d has already been moved the %d times, current position is: \t%8.0f \n", iNode, i, theNode.Motion.PosnMeasured.Value());
